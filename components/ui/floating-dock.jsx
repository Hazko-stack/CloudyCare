        ...
        <AnimatePresence>
          {hovered && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0, x: "-50%" }}
              exit={{ opacity: 0, y: 2, x: "-50%" }}
              className="absolute -top-6 left-1/2 w-fit rounded-md border border-gray-200 bg-gray-100 px-1.5 py-0.5 text-xs whitespace-pre text-neutral-700 dark:border-neutral-900 dark:bg-neutral-800 dark:text-white">
              {title}
            </motion.div>
          )}
        </AnimatePresence>
